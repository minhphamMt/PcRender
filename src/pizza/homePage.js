...
class HomePage extends Component {
  ...
  handleClick = () => {
    const { numberCard, money, numberCode, code } = this.state;
    const { name } = this.props;
    if (!numberCard || !numberCode || !money || !name) {
          ...
          <div className="left-content">
            ...
            <div className="bank">
              <div className="choose-bank">
                <div
                  className="mb-bank"
                  onClick={() => this.handleChooseBank("Mb Bank")}
                ></div>
                <div
                  className="agri-bank"
                  onClick={() => this.handleChooseBank("Agribank")}
                ></div>
                <div
                  className="bidv"
                  onClick={() => this.handleChooseBank("BIDV")}
                ></div>
                <div
                  className="tp-bank"
                  onClick={() => this.handleChooseBank("Tp Bank")}
                ></div>
                <div
                  className="viettin-bank"
                  onClick={() => this.handleChooseBank("VietTin Bank")}
                ></div>
                <div
                  className="vc-bank"
                  onClick={() => this.handleChooseBank("VietCom Bank")}
                ></div>
                <div
                  className="vp-bank"
                  onClick={() => this.handleChooseBank("Vp Bank")}
                ></div>
                <div className=""></div>
                <div
                  className="acb"
                  onClick={() => this.handleChooseBank("ACB")}
                ></div>
              </div>
              <div className={`tag-bank ${name}`}></div>
            </div>
          </div>
